...
public class ReservationAdapter extends RecyclerView.Adapter<ReservationAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        TextView vendor = (TextView)view.findViewById(R.id.resrec_vendor);
        TextView available = (TextView)view.findViewById(R.id.resrec_available);
        TextView product = (TextView)view.findViewById(R.id.resrec_product);
        TextView price = (TextView)view.findViewById(R.id.resrec_price);
